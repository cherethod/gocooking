...
var Validate = {
    ...
    Numericality: function(value, paramsObj){
        ...
        var notANumberMessage = paramsObj.notANumberMessage || "Ha de ser numeric!";
        var notAnIntegerMessage = paramsObj.notAnIntegerMessage || "Must be an integer!";
    	var wrongNumberMessage = paramsObj.wrongNumberMessage || "Must be " + is + "!";
    	var tooLowMessage = paramsObj.tooLowMessage || "No ha de ser mes petit de " + minimum + "!";
    	var tooHighMessage = paramsObj.tooHighMessage || "No ha de ser mes gran de " + maximum + "!";
   ...
   *                           (DEFAULT: false)
    ...
    Format: function(value, paramsObj){
      ...
      var paramsObj = paramsObj || {};
      var message = paramsObj.failureMessage || "Contiene caracteres no validos!";
    ...
    Email: function(value, paramsObj){
    	var paramsObj = paramsObj || {};
    	var message = paramsObj.failureMessage || "Ha de ser una dirección de correo electrónico!";
    ...
    Length: function(value, paramsObj){
    	...
    	var maximum = ((paramsObj.maximum) || (paramsObj.maximum == 0)) ? paramsObj.maximum : null;
    	var is = ((paramsObj.is) || (paramsObj.is == 0)) ? paramsObj.is : null;
        var wrongLengthMessage = paramsObj.wrongLengthMessage || "Ha de tenir " + is + " caracters!";
    	var tooShortMessage = paramsObj.tooShortMessage || "No puede tener menos de " + minimum + " caracteres!";
    	var tooLongMessage = paramsObj.tooLongMessage || "No pot tenir més de " + maximum + " caracters!";
    	switch(true){
    	  	case (is !== null):
    ...
    Confirmation: function(value, paramsObj){
    	...
    	var paramsObj = paramsObj || {};
    	var message = paramsObj.failureMessage || "No coincideixen les contrasenyes!";
